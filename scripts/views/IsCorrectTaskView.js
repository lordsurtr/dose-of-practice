...
class IsCorrectTaskView {
  ...
  render(task) {
    ...
    this.question.innerHTML = `Чи це речення правильне?: <br><span class="question-highlight">${task.sentence}</span>`
...
export default IsCorrectTaskView 
